...
from asistent.utils.deployment import (
    parse_env_vars,
    print_deployment_success,
    write_deployment_metadata,
)
from asistent.utils.gcs import create_bucket_if_not_exists
from asistent.utils.tracing import CloudTraceLoggingSpanExporter
from asistent.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-adk-rag-agent-logs"
